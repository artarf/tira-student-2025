 ...
 */
@DisplayName("Tests for Dijkstra's algorithm")
@EnabledIf("checkIfImplemented")
class DijkstraSearchTests {
    ...
    void testDijkstraSearchWithIntegers() {
        ...
        Graph<Integer>.DijkstraResult<Integer> result = testGraph.doDijkstra(testGraph.graph.getVertexFor(1),
                testGraph.graph.getVertexFor(4));
    ...
    void testTrainStationSearchOuluTurku() {
        ...
        Graph<String> network = StringTestGraph.createFinlandTrainNetworks(listener);
