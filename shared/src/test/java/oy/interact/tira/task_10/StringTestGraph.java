...
public class StringTestGraph {
	
	// Test data from C++ demo.
    public static Graph<String> createFinlandTrainNetworks(GraphPathListener<String> listener) {
        Graph<String> network = new Graph<>(listener);
