...
public class Vertex<T> {
    ...
    * 
    * NB: The constructor is package protected so vertices cannot be created outside of 
    * this graph package. Always create a new
    * vertex for the graph using Graph.createVertexFor(T dataItem).
    * This creates the vertex, adds empty set of edges to it and
