...
public class ResultsPanel extends JPanel {
   ...
   private static final int WORD_LIST_WIDTH = 600;
   ...
   void createGraphicRepresentation() throws IOException {
      ...
      for (int wordItem = 1; wordItem <= uniqueWordCount; wordItem++) {
      ...
      final Dimension dimension = new Dimension(WORD_CLOUD_SIZE, WORD_CLOUD_SIZE); 
