...
public class BooksAndWordsApp 
{
    ...
    public static void main( String[] args )
    {
        ...
        do {
            System.out.print("Give the name of the book file > ");
            String bookFile = in.nextLine();
            System.out.print("Give the name of the words to ignore file > ");
            String wordsToIgnoreFile = in.nextLine();
            try {
                long start = System.currentTimeMillis();
                System.out.println("Processing....");
                // STUDENT: TODO: decide which book to use, BST or Hashtable
                BookBase theBook = BookFactory.createBadBook();
                System.out.format("Using implementation: %s", theBook.getImplementationName());
                ...
                System.out.println("*** ERROR: Did you forget to implement BookFactory methods?!");
